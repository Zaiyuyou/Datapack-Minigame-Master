#矫正匕首位置
execute as @s[nbt={Inventory:[{tag:{Knife:1}}]},nbt=!{Inventory:[{tag:{Knife:1},Slot:0b}]}] run tag @s add mm_dislocate_knife
execute as @s[tag=mm_dislocate_knife] run clear @s #mm:knife
execute as @s[tag=mm_dislocate_knife] run loot replace entity @s hotbar.0 loot mm:knife
execute as @s[tag=mm_dislocate_knife] run tag @s remove mm_dislocate_knife


#掷出
execute as @s[scores={mm_throw_second=-1,mm_cd_second=-1},nbt=!{Inventory:[{tag:{Knife:1},Slot:0b}]}] at @s if entity @e[type=item,nbt={Item:{tag:{Knife:1}}},distance=..5] run tag @s add mm_throw

execute as @s[tag=mm_throw,scores={mm_thrown_knife=1..}] run scoreboard players operation @s mm_throw_tick = infection_cooldown_throw_tick mm_settings
execute as @s[tag=mm_throw,scores={mm_thrown_knife=1..}] run scoreboard players operation @s mm_throw_second = infection_cooldown_throw_second mm_settings
execute as @s[tag=mm_throw] at @s run kill @e[type=item,nbt={Item:{tag:{Knife:1}}},limit=1,sort=nearest]
execute as @s[tag=mm_throw] run loot replace entity @s hotbar.0 loot mm:knife
...
#取消掷出
execute as @s[scores={mm_throw_second=0..,mm_cd_second=-1},nbt=!{Inventory:[{tag:{Knife:1},Slot:0b}]}] at @s if entity @e[type=item,nbt={Item:{tag:{Knife:1}}},distance=..5] run tag @s add mm_cancel_throw
...
execute as @s[tag=mm_cancel_throw] run loot replace entity @s hotbar.0 loot mm:knife
...
#冷却
execute as @s[scores={mm_cd_second=0..},nbt=!{Inventory:[{tag:{Knife:1},Slot:0b}]}] at @s if entity @e[type=item,nbt={Item:{tag:{Knife:1}}},distance=..5] run tag @s add mm_cd_throw
execute as @s[tag=mm_cd_throw] at @s run kill @e[type=item,nbt={Item:{tag:{Knife:1}}},limit=1,sort=nearest]
execute as @s[tag=mm_cd_throw] run loot replace entity @s hotbar.0 loot mm:knife
...
execute as @s[tag=mm_throwing] run scoreboard players remove @s mm_thrown_knife 1
