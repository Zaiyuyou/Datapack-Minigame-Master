...
execute as @a[tag=!mm_dead,tag=mm_hero] unless entity @s[tag=detective,tag=origin] run tellraw @a [{"text":"§e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e "},{"text":"英雄: ","color":"gray"},{"selector":"@s","color":"gray"}]
execute as @a[tag=mm_dead,tag=mm_hero] unless entity @s[tag=detective,tag=origin] run tellraw @a [{"text":"§e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e "},{"text":"英雄: ","color":"gray"},{"selector":"@s","color":"gray","strikethrough":"true"}]
