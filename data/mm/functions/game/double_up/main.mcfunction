...
#显示标题和消息及定时性事件
execute if score game_tick mm_main matches 20 if score game_second mm_main = get_weapon_5 mm_data run tellraw @a[tag=mm_innocent] [{"text":"杀手们将在","color":"yellow"},{"text":"5","color":"red"},{"text":"秒后获得他们的剑!","color":"yellow"}]
...
execute if score game_tick mm_main matches 20 if score game_second mm_main = get_weapon_4 mm_data run tellraw @a[tag=mm_innocent] [{"text":"杀手们将在","color":"yellow"},{"text":"4","color":"red"},{"text":"秒后获得他们的剑!","color":"yellow"}]
...
execute if score game_tick mm_main matches 20 if score game_second mm_main = get_weapon_3 mm_data run tellraw @a[tag=mm_innocent] [{"text":"杀手们将在","color":"yellow"},{"text":"3","color":"red"},{"text":"秒后获得他们的剑!","color":"yellow"}]
...
execute if score game_tick mm_main matches 20 if score game_second mm_main = get_weapon_2 mm_data run tellraw @a[tag=mm_innocent] [{"text":"杀手们将在","color":"yellow"},{"text":"2","color":"red"},{"text":"秒后获得他们的剑!","color":"yellow"}]
...
execute if score game_tick mm_main matches 20 if score game_second mm_main = get_weapon_1 mm_data run tellraw @a[tag=mm_innocent] [{"text":"杀手们将在","color":"yellow"},{"text":"1","color":"red"},{"text":"秒后获得他们的剑!","color":"yellow"}]
...
#道具掉落及效果
execute if score game_mode mm_main matches 8 if score game_second mm_main <= get_weapon_0 mm_data run function mm:game/game_module/prop/prop_spawn
...
#底部
function mm:game/game_module/classic/actionbar_display


#胜负判定
execute if score innocent_left mm_data matches 0 run function mm:game/double_up/end
execute if score murderer_left mm_data matches 0 run function mm:game/double_up/end
execute if score game_second mm_main matches 0 run function mm:game/double_up/end