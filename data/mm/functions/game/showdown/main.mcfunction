...
execute if score game_tick mm_main matches 20 if score game_second mm_main = get_weapon_0_short mm_data as @a run loot replace entity @s hotbar.0 loot mm:bow/showdown
execute if score game_tick mm_main matches 20 if score game_second mm_main = get_weapon_0_short mm_data as @a run loot replace entity @s hotbar.1 loot mm:knife
