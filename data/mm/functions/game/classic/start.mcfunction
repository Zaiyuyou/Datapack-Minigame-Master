...
#道具模式说明
execute if score game_mode mm_main matches 5 run tellraw @a {"text":"=============================================","color":"green"}

execute if score game_mode mm_main matches 5 run tellraw @a [{"text":"§e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e "},{"text":"道具模式","bold":"true"}]
execute if score game_mode mm_main matches 5 run tellraw @a [{"text":"§e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e "},{"text":"巧妙地利用地图中的道具赢得游戏","color":"yellow"}]
