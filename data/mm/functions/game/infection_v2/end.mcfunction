...
execute if score game_second mm_main < get_weapon_0 mm_data if score infected_real_left mm_data matches 0 as @a[tag=mm_survivor] run scoreboard players operation @s mm_survive_time -= game_second mm_main
...
execute if score game_second mm_main < get_weapon_0 mm_data if score infected_real_left mm_data matches 0 run tellraw @a [{"text":"§e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e "},{"text":"胜利者:"},{"text":"幸存者","color":"green"}]
...
execute if score game_second mm_main < get_weapon_0 mm_data if score infected_real_left mm_data matches 0 run scoreboard players add @a[tag=mm_survivor] mm_stats_1 1
...
execute if entity @a[tag=mm_alpha] run tellraw @a ""

execute as @a[tag=mm_alpha,tag=!mm_dead] run tellraw @a [{"text":"§e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e "},{"text":"母体: ","color":"gray"},{"selector":"@s","color":"gray"},{"text":" ("},{"score":{"objective":"mm_kill_count","name":"@s"},"color":"green"},{"text":" 杀)"}]
execute as @a[tag=mm_alpha,tag=mm_dead] run tellraw @a [{"text":"§e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e "},{"text":"母体: ","color":"gray"},{"selector":"@s","color":"gray","strikethrough":"true"},{"text":" ("},{"score":{"objective":"mm_kill_count","name":"@s"},"color":"green"},{"text":" 杀)"}]

execute if entity @a[tag=!mm_alpha,tag=!mm_ranked] run tellraw @a ""

execute if entity @a[tag=!mm_alpha,tag=!mm_ranked] run tellraw @a [{"text":"§e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e "},{"text":"幸存者排行"}]

##第一名
execute as @a[tag=!mm_alpha,tag=!mm_ranked] run scoreboard players operation @s mm_top_1 = @s mm_survive_time
execute as @a[tag=!mm_alpha,tag=!mm_ranked] run scoreboard players operation @s mm_top_1 > @a[tag=!mm_ranked] mm_top_1
execute as @a[tag=!mm_alpha,tag=!mm_ranked] run scoreboard players operation @s mm_top_1 -= @s mm_survive_time
execute as @a[tag=!mm_alpha,tag=!mm_ranked,scores={mm_top_1=0}] run tellraw @a [{"text":"§e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e "},{"text":"#1 ","color":"white"},{"selector":"@s","color":"gray"},{"text":" (","color":"white"},{"score":{"objective":"mm_survive_time","name":"@s"},"color":"green"},{"text":"s","color":"green"},{"text":")(","color":"white"},{"score":{"objective":"mm_kill_count_s","name":"@s"},"color":"green"},{"text":" 杀)","color":"white"}]
execute as @a[tag=!mm_alpha,tag=!mm_ranked,scores={mm_top_1=0}] run scoreboard players reset @s mm_survive_time
execute as @a[tag=!mm_alpha,tag=!mm_ranked,scores={mm_top_1=0}] run tag @s add mm_ranked
