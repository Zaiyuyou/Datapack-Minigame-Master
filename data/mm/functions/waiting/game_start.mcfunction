...
#开始游戏
tellraw @a {"text":"游戏已开始!","color":"yellow"}
...
execute as @e[name="prop_spawn_changeless"] run scoreboard players add @s mm_main 0



#传送玩家
execute as @a at @e[tag=mm_spawn,limit=1,sort=random,tag=mm_actived] run tp @s ~ ~3 ~
