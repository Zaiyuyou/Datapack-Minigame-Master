execute unless score game_start mm_main matches 2 as @s run scoreboard players set game_mode mm_main 6
...
execute unless score game_start mm_main matches 2 as @s run title @a subtitle [{"text":"游戏模式已设置为","color":"yellow"},{"text":"生存","color":"light_purple"},{"text":"!","color":"yellow"}]
