execute unless score game_start mm_main matches 2 as @s run scoreboard players set game_mode mm_main 5
execute unless score game_start mm_main matches 2 as @s run scoreboard players set murderer_count mm_settings 1
...
execute unless score game_start mm_main matches 2 as @s run title @a subtitle [{"text":"游戏模式已设置为","color":"yellow"},{"text":"道具","color":"light_purple"},{"text":"!","color":"yellow"}]
